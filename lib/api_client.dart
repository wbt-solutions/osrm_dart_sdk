    ...
    try {
      switch (targetType) {
        ...
        case 'AnnotationMetadata':
          return AnnotationMetadata.fromJson(value);
        case 'ApiResponse':
          return ApiResponse.fromJson(value);
        case 'Intersection':
          return Intersection.fromJson(value);
        case 'Lane':
          return Lane.fromJson(value);
        case 'NearestResponse':
          return NearestResponse.fromJson(value);
        case 'NearestResponseAllOf':
          return NearestResponseAllOf.fromJson(value);
        case 'NearestWaypoint':
          return NearestWaypoint.fromJson(value);
        case 'NearestWaypointAllOf':
          return NearestWaypointAllOf.fromJson(value);
        case 'Route':
          return Route.fromJson(value);
        case 'RouteLeg':
          return RouteLeg.fromJson(value);
        case 'RouteResponse':
          return RouteResponse.fromJson(value);
        case 'RouteResponseAllOf':
          return RouteResponseAllOf.fromJson(value);
        case 'RouteStep':
          return RouteStep.fromJson(value);
        case 'StepManeuver':
          return StepManeuver.fromJson(value);
        case 'TableResponse':
          return TableResponse.fromJson(value);
        case 'TableResponseAllOf':
          return TableResponseAllOf.fromJson(value);
        case 'TripResponse':
          return TripResponse.fromJson(value);
        case 'TripResponseAllOf':
          return TripResponseAllOf.fromJson(value);
        case 'TripWaypoint':
          return TripWaypoint.fromJson(value);
        case 'TripWaypointAllOf':
          return TripWaypointAllOf.fromJson(value);
        case 'Waypoint':
